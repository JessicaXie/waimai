<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="isShowBulletin=true">
      ...
      <div class="header-content">
        ...
        <div class="shop-message">
          ...
          <span class="shop-message-detail">月售{{info.seRllCount}}单</span>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="idShowSupport=true">
      <div class="discounts-left">
        <div class="activity" :class="activityClasses[info.supports[0].type]">
          <span class="content-tag">
            <span class="mini-tag">{{info.supports[0].name}}</span>
          </span>
          <span class="activity-content">新用户下单立减{{info.supports[0].content}}元</span>
        </div>
      </div>
    ...
    <div class="shop-brief-modal" v-show="isShowBulletin">
      <div class="brief-modal-content">
        ...
        <h3 class="brief-modal-title">
          <span>公告</span></h3>
        <div class="brief-modal-notice ellipsis">
          {{info.bulletin}}
        </div>
      ...
      <div class="activity-sheet-content">
        ...
        <ul class="list">
          <li class="activity-item activity-green" v-for="(support, index) in info .supports" :key="index">
            ...
            <span class="activity-content ellipsis">{{support.content }}</span>
          </li>
        </ul>
        <div class="activity-sheet-close" @click="idShowSupport=false">
          <span class="iconfont icon-close"></span>
        </div>
      </div>
